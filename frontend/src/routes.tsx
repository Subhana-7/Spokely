...
const GoogleRedirectHandler = lazy(() => import("./modals/GoogleRedirectHandler"));
...
const MentorProfile = lazy(() => import("./pages/mentor/MentorSelfViewProfilePage"));
const UserViewMentorProfile = lazy(() => import("./pages/user/UserViewMentorProfile"));
const MentorViewUserProfile = lazy(() => import("./pages/mentor/MentorViewUserProfile"));
const SessionsHub = lazy(() => import("./pages/Sessions/MentorSessionsHub"));
const MentorPublicSessions = lazy(() => import("./pages/Sessions/PublicSessions"));
const MentorScheduleSession = lazy(() => import("./pages/Sessions/MentorScheduleSession"));
...
const PublicMentorListing = lazy(() => import("./pages/user/publicMentorListing"));
const PaymentManagement = lazy(() => import("./pages/admin/PaymentManagement"));
const DailyTaskManagement = lazy(() => import("./pages/admin/DailyTaskManagement"));
