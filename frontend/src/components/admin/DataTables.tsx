  ...
  return (
    <div className="space-y-4">
        ...
        <table className="w-full text-sm text-left">
          <thead className="bg-gray-50 text-gray-700 font-semibold">
            <tr>
              ...
              <th className="px-6 py-3">{type === 'user' ? 'Level' : 'Students'}</th>
              <th className="px-6 py-3">{type === 'user' ? 'Daily Task' : 'Status'}</th>
              ...
              <tr key={item.id} className="hover:bg-gray-50 border-t">
                ...
                <td className="px-6 py-4">
                  {type === 'user' ? (
                    ...
                    <span className="font-medium text-gray-900">{item.students}</span>
                  )}
                </td>
                ...
                <td className="px-6 py-4">
                  <span className="font-medium text-gray-900">{item.sessions}</span>
                </td>

                {type === 'user' && (
                  <td className="px-6 py-4">
                    <span className="font-medium text-gray-900">{item.mentors}</span>
                  </td>
                )}
      ...
      <div className="flex justify-center space-x-1 mt-4 text-sm">
        ...
        <a href="#" className="px-3 py-1 rounded border text-gray-600 hover:bg-gray-100">2</a>
        <a href="#" className="px-3 py-1 rounded border text-gray-600 hover:bg-gray-100">3</a>
        <a href="#" className="px-3 py-1 rounded border text-gray-600 hover:bg-gray-100">Next</a>
      </div>
    </div>
  );
};
