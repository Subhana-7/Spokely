          ...
          <div className="xl:col-span-1">
            <SpokelyCard className="p-8">
              <div className="text-center">
                ...
                <h2 className="text-2xl font-bold text-gray-900 mb-3">{user?.name || "User Name"}</h2>
            ...
            <div className="grid grid-cols-2 gap-4 mt-6">
              <SpokelyCard className="p-6 text-center">
                <div className="text-3xl font-bold text-indigo-600 mb-2">{user?.sessionsDone ?? 0}</div>
