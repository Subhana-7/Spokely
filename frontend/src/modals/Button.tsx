...
interface ButtonProps extends React.ButtonHTMLAttributes<HTMLButtonElement> {
  variant?: 'primary' | 'google' | 'secondary' | 'danger' | 'success' | 'warning' ;
...
const Button: React.FC<ButtonProps> = ({ variant = 'primary', children, ...props }) => {
  ...
  const variants = {
    ...
    warning: "bg-gradient-to-r from-yellow-500 to-orange-500 hover:from-yellow-600 hover:to-orange-600 text-white focus:ring-yellow-500 shadow-lg hover:shadow-xl"
  };
