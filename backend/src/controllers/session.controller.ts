...
export class SessionController implements ISessionController {
  ...
  respondToInvite = async (
    ...
    try {
      const updated = await this._sessionService.respondToInvite(
        req.params.id,
        req.id!,
        req.body.status
      );
  ...
  cancelParticipation = async (
    ...
    try {
      const updated = await this._sessionService.cancelParticipation(
        req.params.id,
        req.id!,
        req.body.reason
      );
  ...
  cancelSession = async (
    ...
    try {
      const updated = await this._sessionService.cancelSession(
        req.params.id,
        req.body.userId,
        req.body.reason
      );
  ...
  flagSession = async (
    ...
    try {
      const updated = await this._sessionService.flagSession(
        req.params.id,
        req.id!,
        req.body.reason,
  ...
  addFeedback = async (
    ...
    try {
      const updated = await this._sessionService.addFeedback(
        req.params.id,
        req.id!,
        req.body.to,
        req.body.comment,
