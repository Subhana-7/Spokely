import { UserResponseDTO, SignupDTO, LoginDTO, ForgotPasswordDTO, VerifyForgotPasswordDTO } from "../../dto/user.dto";
...
export interface IUserService {
  ...
  verifyForgotPassword(data: VerifyForgotPasswordDTO): Promise<{ message: string }>;
  ...
  refreshToken(token: string): Promise<{ user: UserResponseDTO; accessToken: string }>;
}
